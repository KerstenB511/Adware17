...
# Form implementation generated from reading ui file 'C:\Users\kaste\Desktop\Uni\AgentsAndInterfaces\CourseProject\Interface\Setup_Fin.ui'
#
...
from Setup_Close import Ui_Credits
...
class Ui_FinWindow(object):
    ...
    def goBack(self):
     ...
     #   self.ui = Ui_MainSetupWindow()
      #  self.ui.setupUi(self.window)
       # self.ui.setCurrentIndex(3)
        MSW.show()
        FW.destroy()
       # self.window.show()

    def selectFile(self):
        tu = QtWidgets.QFileDialog.getExistingDirectory()
        self.lineEdit.setText(str(tu))
    ...
    def setupUi(self, FinWindow, MSWnew):
        global MSW, FW
        FW = FinWindow
        MSW = MSWnew
        ...
        self.buttonCancel01.clicked.connect(self.goBack)
        ...
        self.buttonNext01.clicked.connect(lambda: FinWindow.setCurrentIndex(1))
        self.buttonNext01.clicked.connect(self.install)
        ...
        self.pushButton_2.clicked.connect(self.openCredits)
